...
const drawCircle = () => {
    ...
    circle.setColor = color_input.value
    circle.draw(ctx)
}
...
const drawLine = () => {
    ...
    line.setLineWidth = line_width_input.value
...
const drawRectagle = () => {
    ...
    rectangle.setLineWidth = line_width_input.value
    rectangle.setColor = color_input.value
    rectangle.draw(ctx)
}
...
const drawSquare = () => {
    ...
    const y = y_input.value
    const width = document.querySelector('div#third input').value
    const height = document.querySelector('div#third input').value
    const rectangle = new Rectangle(x,y,width,height)
    rectangle.setLineWidth = line_width_input.value
    rectangle.setColor = color_input.value
    rectangle.draw(ctx)
